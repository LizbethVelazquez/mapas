...
public final class ItemBinding implements ViewBinding {
  ...
  private ItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView lat,
      @NonNull TextView lng, @NonNull TextView name) {
  ...
  public static ItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBinding((ConstraintLayout) rootView, lat, lng, name);
    }
